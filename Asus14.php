...
<body>
    ...
    <section class="content">
        <div class="img">
            <img src="Images_PC/img1.JPG" alt="Ordinateur portable Asus14">
        </div>
        <div class="details">
            <h2>Ordinateur portable Asus14</h2>
            <p>
                L'ordinateur portable Asus14 est doté d'un processeur puissant, d'un écran Full HD et d'une autonomie longue durée. Il offre une performance exceptionnelle pour le travail et les loisirs.
            </p>
            <p class="price">Prix : 799,99 €</p>
            <form action="panier.php" method="post">
                <input type="hidden" name="product_name" value="Ordinateur portable Asus14">
