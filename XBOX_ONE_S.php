    ...
    <section class= "content">
        ...
        <div class="product-details">
            <div class="product-info">
                <h2>Xbox One X</h2>
                <p>La Xbox One X est une console de jeu vidéo de huitième génération développée par Microsoft. Elle offre des graphismes en 4K et est compatible avec une large gamme de jeux.</p>
                <p class="price">Prix : 499,99 €</p>
                <form action="panier.php" method="post">
                    <input type="hidden" name="product_name" value="Xbox One X">
