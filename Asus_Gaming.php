...
<body>
    ...
    <section class="content">
        <div class="img">
            <img src="Images_PC/img2.JPG" alt="Ordinateur portable Asus Gamer">
        </div>
        <div class="details">
            <h2>Ordinateur portable Asus Gamer</h2>
            <p>
                L'ordinateur portable Asus Gamer est conçu pour offrir une expérience de jeu immersive. Avec son processeur rapide, sa carte graphique performante et son écran haute résolution, il vous permet de profiter de vos jeux préférés avec une qualité exceptionnelle.
            </p>
            <p class="price">Prix : 1299,99 €</p>
            <form action="panier.php" method="post">
                <input type="hidden" name="product_name" value="Ordinateur portable Asus Gamer">
